...
export function handleHelp(_args: string): Message[] {
  const lines = [
    ...
    '',
    'Quick Start',
    '  /quick                Quick clone Airbnb-style design system',
    '  /clone http://www.tensorui.cn/api/projects/1e69bd8c-c014-4ccd-adb3-ec7d4061b5ba/download',
    '',
    'Commands',
    '  /quick               Quick start with Airbnb design system',
